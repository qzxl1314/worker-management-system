...
public class office extends AppCompatActivity {
        ...
        input.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty()||name.equals("")){
                    ToastUtils.show(office.this,"部门名不可为空！");
                }else {
                    insert(name);
                }
                work.setText(null);
    ...
    private void insert(String workname) {
        ...
        Cursor mCursor = sqldb.query("office", null, "office_name=?", new String[]{workname}, null, null,
                null);
        //游标置顶
        mCursor.moveToFirst();
        if (mCursor.getCount()==0) {
            ...
            values.put("office_name", workname);
            //执行插入操作
            sqldb.insert("office", null, values);
            ToastUtils.show(office.this, "插入成功");
            getlist();
        }else{
            ToastUtils.show(office.this, "插入失败，数据已经存在！");
            work.setText("");
        }
    }
    ...
    public void getlist() {
        ...
        adapter = new MyAdapter(office.this,data);
        ...
        adapter.setOnItemDeleteClickListener(new MyAdapter.onItemDeleteListener() {
            ...
            public void onDeleteClick(final int i) {
                Dialog dialog = new AlertDialog.Builder(office.this)
    ...
    private void delete(String workname) {
        ...
        sqldb.delete("office", "office_name=?", new String[]{workname});//删除name的值是jack的那条记录
    }
}
